...
- [`f3dx`](https://github.com/smigolsmigol/f3dx): Rust runtime your Python imports. Drop-in for openai + anthropic SDKs. Native SSE streaming, agent loop with concurrent tool dispatch, OTel emission.
- [`f3dx-cache`](https://github.com/smigolsmigol/f3dx-cache): Content-addressable LLM response cache + replay. Zero-cost CI runs against captured prod traces.
- [`pydantic-cal`](https://github.com/smigolsmigol/pydantic-cal): Calibration metrics for pydantic-evals. ECE, Brier, reliability diagrams, Fisher-Rao geometry.
